  ...
  return (
    <div style={{ display: "flex", gap: 12, marginBottom: 10 }}>
      <span style={{
        ...
        color: "#1A1A1A", minWidth: 72, flexShrink: 0,
      }}>
        {label}
      </span>
      <span style={{
...
export default function OrderConfirmation() {
  ...
  const subtotal = order?.items?.reduce(
    (acc, item) => acc + (item.priceAtPurchase || 0) * item.quantity, 0
  ) ?? 0;
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1040, margin: "0 auto" }}>
          ...
          {/* MAIN LAYOUT */}
          {order && (
            <div className="oc-grid" style={{ display: "flex", gap: 48, alignItems: "flex-start" }}>

              {/* ── LEFT COLUMN ── */}
              <div className="col-left" style={{ flex: "0 0 380px", width: 380 }}>

                {/* Animated check */}
                <div style={{ marginBottom: 28 }}>
                  <svg width="48" height="48" viewBox="0 0 72 72" fill="none" style={{ marginBottom: 20 }}>
                  ...
                  <h1 style={{
                    ...
                    color: "#1A1A1A", margin: "0 0 12px", lineHeight: 1.05,
                  }}>
                    Thank you for<br />your purchase!
                  </h1>
                  <p style={{
                    fontFamily: "DM Sans, sans-serif", fontSize: 13,
                    color: "#6B6B6B", margin: "0 0 32px", lineHeight: 1.6, maxWidth: 300,
                  }}>
                ...
                {addr && (
                  <div style={{ marginBottom: 32 }}>
                    ...
                    <InfoRow label="Name"    value={`${addr.firstName} ${addr.lastName}`} />
                    <InfoRow label="Address" value={`${addr.street}, ${addr.city}, ${addr.state} ${addr.zipcode}, ${addr.country}`} />
                ...
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  <Link to="/orders" className="track-btn">Track Your Order</Link>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {[
                      ...
                      { label: "Order Number", value: order._id.slice(-10).toUpperCase() },
                      { label: "Payment",      value: order.paymentStatus === "paid" ? "Paid" : "COD / Pending" },
                    ].map((col, i) => (
                      <div key={i} style={{
                  ...
                  {order.items?.map((item, i) => (
                    ...
                    >
                      {item.product?.images?.[0] ? (
                        ...
                        <div style={{
                          width: 56, height: 74, background: "#F0EFEB",
                          borderRadius: 2, flexShrink: 0,
                        }} />
                      )}
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p style={{
                          ...
                          fontSize: 14, color: "#1A1A1A", margin: "0 0 4px",
                  ...
                  {/* Totals */}
                  <div style={{ padding: "16px 24px", background: "#FAFAF9", borderTop: "1px solid #F0EFEB" }}>
                    {[
