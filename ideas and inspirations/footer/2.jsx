    ...
    <div>
      ...
      {status === "success" ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
          ...
          />
          {status === "error" && (
            <p className="text-[11px] text-red-400">Please enter a valid email.</p>
          )}
          <button
            type="submit"
...
const Footer = () => {
  return (
    <footer className="bg-[#1A1A1A] overflow-hidden relative">
      ...
      {/* ── OPTION A — centered watermark behind all columns ─────────────────
          - absolute, centered both axes
          - very low opacity so columns are fully readable on top
