...
import { getDashboardStats, getDemandPrediction, getInventoryStats, getLowStockProducts, getMonthlyRevenue, getPredictoinOverview, getReports, getRevenueAnalytics, getSalesPrediction, getSalesReports, getTopProducts, getUserChurnPrediction, getUserReports } from "../controllers/adminController.js";
...
adminRouter.get('/inventory/low-stock',authUser, adminAuth, getLowStockProducts)
...
adminRouter.get('/predictions',authUser, adminAuth, getPredictoinOverview)
adminRouter.get('/predictions/sales',authUser, adminAuth, getSalesPrediction)
adminRouter.get('/predictions/demand',authUser, adminAuth, getDemandPrediction)
adminRouter.get('/predictions/churn',authUser, adminAuth, getUserChurnPrediction)
